...
test("longhands properties are expanded", () => {
  ...
  expect(atomic.rules.join("\n")).toMatchInlineSnapshot(`
    ...
    .x-1jt99b7 { border-top-color: rgb(255, 0, 0); }
    .x-oq5rv3 { border-right-color: rgb(255, 0, 0); }
    .x-62bezo { border-bottom-color: rgb(255, 0, 0); }
    .x-4f77ae { border-left-color: rgb(255, 0, 0); }
